...
pub fn verifyPKCS1v1_5(_: *@This(), sig: []const u8, msg: []const u8, pk_der: []const u8, hash_type: rsa_contract.HashType) anyerror!void {
...
pub fn verifyPSS(_: *@This(), sig: []const u8, msg: []const u8, pk_der: []const u8, hash_type: rsa_contract.HashType) anyerror!void {
    const pk = try resolveKey(pk_der);
    switch (hash_type) {
        inline else => |ht| {
            const Hash = StdHash(ht);
...
pub fn parseDer(_: *@This(), pub_key: []const u8) anyerror!rsa_contract.DerKey {
