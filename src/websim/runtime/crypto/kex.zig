...
pub const X25519 = struct {
    pub fn generateDeterministic(_: *X25519, seed: [32]u8) anyerror!x25519_contract.KeyPair {
    ...
    pub fn scalarmult(_: *X25519, secret: [32]u8, public: [32]u8) anyerror![32]u8 {
...
pub const P256 = struct {
    ...
    pub fn computePublicKey(_: *P256, secret_key: [32]u8) anyerror![65]u8 {
        const kp = Ecdsa.KeyPair.generateDeterministic(secret_key) catch |e| return e;
        return kp.public_key.toUncompressedSec1();
    }

    pub fn ecdh(_: *P256, secret_key: [32]u8, peer_public: [65]u8) anyerror![32]u8 {
