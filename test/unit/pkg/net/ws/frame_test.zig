...
const module = embed.pkg.net.ws.frame;
...
const MIN_HEADER_SIZE = module.MIN_HEADER_SIZE;
const readU16Big = module.readU16Big;
const readU64Big = module.readU64Big;
const writeU64Big = module.writeU64Big;
