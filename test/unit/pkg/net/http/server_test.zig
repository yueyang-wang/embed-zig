...
const module = embed.pkg.net.http.server_mod;
...
const connWriteFn = response_mod.connWriteFn;
const MockConn = module.MockConn;
const MockState = MockConn.State;
const testHandler = module.testHandler;
const runtime = embed.runtime;
const Socket = module.Socket;
const SocketConn = module.SocketConn;
const echoHandler = module.echoHandler;
const jsonHandler = module.jsonHandler;
const slowHandler = module.slowHandler;
const test_routes = module.test_routes;
const startTestServer = module.startTestServer;
const serveOne = module.serveOne;
const httpGet = module.httpGet;
const httpPost = module.httpPost;
